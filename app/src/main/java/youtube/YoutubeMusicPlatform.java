...
public class YoutubeMusicPlatform extends MusicPlatform {
    ...
    private static final String CLIENT_ID = "702357035237-ouahdkbqsnt640fkd4c00bksl70tbtes.apps.googleusercontent.com";
    private static final String REDIRECT_URI = "com.undefinedbehaviourgames.grizzly://callback";
    private static final String AUTH_URL = "https://accounts.google.com/o/oauth/v2/auth";
    private static final String TOKEN_URL = "https://oauth2.googleapis.com/token";
    private static final String SCOPE = "https://www.googleapis.com/auth/youtube https://www.googleapis.com/auth/youtube.readonly";
    ...
    public void getUser(String token, Callbacks callbacks) {
        mTidalService.getUser(token).enqueue(new Callback<ResponseBody>() {
            @Override
